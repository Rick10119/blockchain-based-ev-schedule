...
public class TestMovement extends MapBasedMovement {
     ...
     *            the new object to
     */
    protected TestMovement(TestMovement mbm) {
        super(mbm);
...
//                (StationMovement) MM.
                ...
                System.out.print(MM.getHost().getName() + ": ");
